...
<body>
        ...
        <header class="primary-header">
            <div class="container">
                <div class="nav-wrapper">
                    <a class="logo">
                        <i class="fa-solid fa-dumbbell"></i>Fitness-TRIBE</a>
                    ...
                    <a href="register.php"><button class="btn | display-sm-none display-md-inline-flex">Get Started</button></a>
                </div>
            </div>
        </header>
        ...
        <div class="container">
            ...
            <div class="items-wrapper | padding-block-700">
              <div class="program-item">
                    <a href="strength.html"><img src="images/program-img1.jpg" alt=""></a>
                ...
                <div class="program-item">
                    <a href="weight.html"><img src="images/program-img2.jpg" alt=""></a>
                    <div class="program-item-content">
                ...
                <div class="program-item">
                    <a href="fat.html"><img src="images/program-img3.jpg" alt=""></a>
                    <div class="program-item-content">
                ...
                <div class="program-item">
                    <a href="speed.html"><img src="images/program-img4.jpg" alt=""></a>
                    <div class="program-item-content">
   ...
   <section class="pricing | padding-block-900" id="pricing-section">
        <div class="container">
          ...
          <a href="payment.html"> <div class="plans padding-block-700 items-wrapper">
               <div class="plan-item bg-secondary">
                     <h4 class="fs-700 fw-semi-bold">₹2999 <span class="special-text fs-200">/Month</span></h4>
                ...
                <div class="plan-item bg-secondary">
                    <h4 class="fs-700 fw-semi-bold">₹14999 <span class="special-text fs-200">/Year</span></h4>
                    <div class="offer-title">Exclusive Offer</div>
                    <ul class="package-list">
                        <li>TRAINING</li>
                        <li>PT</li>
                ...
                <div class="plan-item bg-secondary">
                    <h4 class="fs-700 fw-semi-bold">₹6999 <span class="special-text fs-200">/ 6 Month</span></h4>
                    <div class="offer-title">Exclusive Offer</div>
                    <ul class="package-list">
                        <li>TRAINING</li>
                        <li>PT</li>
            ...
            <div class="even-columns text-center-sm-only">
                ...
                <div>
                    ...
                    <ul role="list" class="contact-links">
                        <li><a href=""><i class="fa-solid fa-phone"></i>7738048375</a></li>
                        <li><a href=""><i class="fa-solid fa-envelope"></i></i>aniketram1111@gmail.com</a></li>
                        <li><a href=""><i class="fa-solid fa-user"></i>@aniket_123</a></li>
                        <li><a href=""><i class="fa-solid fa-globe"></i>www.gymforce.com</a></li>
                        <li><a href=""><i class="fa-solid fa-location-dot"></i>pimpri shagun chowk pune india 411017 </a></li>
                    </ul>
                </div>
            </div>
            <hr>
            <h5 class="fs-500 fw-semi-bold text-center"><span class="special-text"><i
                        class="fa-solid fa-dumbbell"></i>FITNESS TRIBE</span> Ⓒ 2025 - All Rights Reserved</h5>
        </div>
